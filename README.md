...
The game is called `Tactigon` and it can be found and explored in https://boardgamegeek.com/boardgame/369386/tactigon
...
### 3.1 Internal Game State Representation
...
### 3.3 Move Validation and Execution
